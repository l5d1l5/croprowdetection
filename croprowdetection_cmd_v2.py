...
command = 'Rscript'
path2script = 'C:\Users\darellvdv\Documents\croprowdetection\create_lines_from_python_cmd.R'
...
## LOAD R RESULTS INTO PYTHON ##
import shapely
import fiona
from shapely.geometry import shape

croprowbuffer = fiona.open("D:/Sugarcane_Project/Ecuador_output/croprows.shp", driver = "ESRI shapefile")
pol = croprowbuffer.next()
